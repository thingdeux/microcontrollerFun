...
// ----- JJ Modified ---- //
void RGBMood::setPartyMode(bool toValue) {
  isInPartyMode = toValue;
...
*/
void RGBMood::setHSB(uint16_t h, uint16_t s, uint16_t b) {
...
*/
void RGBMood::setRGB(uint16_t r, uint16_t g, uint16_t b) {
...
*/
void RGBMood::fadeHSB(uint16_t h, uint16_t s, uint16_t b, bool shortest) {
...
@param b The blue (0..255)
*/
void RGBMood::fadeRGB(uint16_t r, uint16_t g, uint16_t b) {
...
void RGBMood::fadeRGB(uint32_t color) {
...
@param b The brightness (0..255)
*/
void RGBMood::hsb2rgb(uint16_t hue, uint16_t sat, uint16_t val, uint16_t& red, uint16_t& green, uint16_t& blue) {
  val = dc[val];
  sat = 255-dc[255-sat];
  hue = hue % 360;
